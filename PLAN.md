...
The app stays French-first (the source data is French). UI copy in French, with source links back to [opendata.paris.fr](https://opendata.paris.fr) and [data.montreuil.fr](https://data.montreuil.fr).
...
- [`app/page.tsx`](app/page.tsx) — public landing
...
- Explicit routes per theme (`app/dashboard/velib/page.tsx`, …)
- [`proxy.ts`](proxy.ts)
...
OAuth, alert emails, CSV export, English i18n, accidentology archive, map marker clustering.
